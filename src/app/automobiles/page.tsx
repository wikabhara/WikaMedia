...
export const metadata: Metadata = {
  ...
  description: "Ikuti berita seputar Otomotif dari New York Times.",
};
...
async function getAutomobilesArticles() {
  const apiKey = process.env.NY_API_KEY;
  const url = `https://api.nytimes.com/svc/topstories/v2/automobiles.json?api-key=${apiKey}`;
...
export default async function AutomobilesPage() {
  const articles = await getAutomobilesArticles();
    ...
    <>
      <div className="bg-base-200">
        <div
          ...
          style={{
            backgroundImage: `url('/automotive.jpg')`,
          }}
        >
          <div className="hero-overlay bg-black/50"></div>
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-md">
              <h1 className="mb-5 text-5xl font-bold">Dunia Dalam Otomotif</h1>
              <p className="mb-5">
                Ikuti berita seputar Otomotif dari New York Times.
              </p>
            </div>
          </div>
        </div>
